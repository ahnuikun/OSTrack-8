...
**Option1**: Use the Anaconda environment for the 4x RTX 4090 server
```
bash install.sh track
conda activate track
```

**Option2**: Create the same environment from YAML
```
conda env create -f ostrack_track_cu128_env.yaml
```
