...
cfg.MODEL.MSTF.GATE_TEMPERATURE = 1.0
cfg.MODEL.MSTF.LOCAL_BIAS = 0.55
cfg.MODEL.MSTF.MID_BIAS = 0.35
cfg.MODEL.MSTF.CONTEXT_BIAS = -1.20
cfg.MODEL.MSTF.CONTEXT_GATE = True
cfg.MODEL.MSTF.CONTEXT_GATE_BIAS = -1.50
cfg.MODEL.MSTF.RESIDUAL_CONFIDENCE_GATE = True
cfg.MODEL.MSTF.RESIDUAL_FLOOR = 0.65
cfg.MODEL.MSTF.RESIDUAL_INIT = 0.07
